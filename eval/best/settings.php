...
$settings->add(new admin_setting_configselect('workshopeval_best/comparison', get_string('comparison', 'udmworkshopeval_best'),
                    get_string('configcomparison', 'udmworkshopeval_best'), 5, $options));
