...
/**
 * The mod_udmworkshop submission deleted event.
 *
...
/**
 * The mod_udmworkshop submission deleted event class.
 *
...
class submission_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsubmissiondeleted', 'udmworkshop');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'udmworkshop', 'delete submission',
