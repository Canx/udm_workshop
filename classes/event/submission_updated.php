...
/**
 * The mod_udmworkshop submission updated event.
 *
...
/**
 * The mod_udmworkshop submission updated event class.
 *
...
class submission_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionupdated', 'udmworkshop');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'udmworkshop', 'update submission',
