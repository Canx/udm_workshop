...
/**
 * The mod_udmworkshop assessment_reevaluated event.
 *
...
/**
 * The mod_udmworkshop assessment_reevaluated event class.
 *
...
class assessment_reevaluated extends \core\event\base {
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'udmworkshop', 'update aggregate grade', 'view.php?id=' . $this->contextinstanceid,
    ...
    public static function get_name() {
        return get_string('eventassessmentreevaluated', 'mod_udmudmworkshop');
    }
