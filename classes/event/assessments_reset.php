...
/**
 * The mod_udm_workshop submission assessments reset event.
 *
...
/**
 * The mod_udm_workshop submission assessments reset event class.
 *
...
class assessments_reset extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionassessmentsreset', 'mod_udm_workshop');
    }
