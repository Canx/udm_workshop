...
$PAGE->set_url('/mod/udmworkshop/index.php', array('id' => $course->id));
$PAGE->set_title($course->fullname);
$PAGE->set_heading($course->shortname);
$PAGE->navbar->add(get_string('modulenameplural', 'udmworkshop'));
...
foreach ($workshops as $workshop) {
    if (empty($workshop->visible)) {
        $link = html_writer::link(new moodle_url('/mod/udmworkshop/view.php', array('id' => $workshop->coursemodule)),
...
echo $OUTPUT->heading(get_string('modulenameplural', 'udmworkshop'), 3);
