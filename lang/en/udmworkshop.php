...
$string['allocatedetailsnosubmission'] = 'expected: {$a->expected}<br />to allocate: {$a->allocate}';
$string['allocateshouldnotassess'] = '<br />who should not assess: {$a->shouldnotassess}';
$string['allocatewaitingtoassess'] = '<br />waiting to assess: {$a->waiting}';
$string['allocation'] = 'Submission allocation';
$string['allocationdonedetail'] = 'Allocation done. {$a}';
...
$string['allowsubmission'] = 'Allow submissions';
$string['allowsubmission_help'] = 'If enabled, an author may submit their work for assessment. You can not change this value when you are not in phase Setup or a submission is done by a least one participant.';
...
$string['assessassoonsubmitted'] = 'Allow assessment after submission';
$string['assessassoonsubmitted_help'] = 'If enabled, a peer will be able to assess a work as soon this later is submitted.';
$string['assessedexample'] = 'Assessed example submission';
$string['assessedpeer'] = 'Assessed peer';
$string['assessedsubmission'] = 'Assessed submission';
$string['assessingexample'] = 'Assessing example submission';
$string['assessingpeer'] = 'Assessing peer';
...
$string['assessmentdeleted'] = 'Assessment deallocated. {$a}';
...
$string['assessmentgradeof'] = 'Grade from peer (of {$a})';
$string['assessmentgrade'] = 'Grade from peer';
...
$string['assessmenttype_help'] = 'You must indicate who should assess the workshop. You can not change this value when an assessment or a submission is done by a least one participant.';
$string['assessmentweight'] = 'Assessment weight';
$string['assessmentweight_help'] = 'By choosing a multiplier you can give more weight to a whole evaluation in the perspective to combine it with other ones. The default multiplier is “1”.

Say, you want to combine multiple evaluations of an oral presentation, you can have the following (or any) set of multiplier:

- auto-evaluation = default value of “1”
- peer evaluation = “2” as a multiplier
- evaluation by the teacher = “3” as a multiplier

That way, in the mean result, the peer evaluation will weight twice as much as the auto-evaluation, and the evaluation of the teacher will weight as much as the two other evaluations.';
$string['assesswithoutsubmission'] = 'Users can evaluate others without having submitted their own assignment';
$string['assesswithoutsubmission_help'] = 'If activated, a user can evaluate others without having submitted his own work.';
...
$string['calculateworkgrades'] = 'Calculate work grades';
...
$string['closeanddisplay'] = 'Close and display';
...
$string['displayappraiseesname'] = 'Display appraisees name';
$string['displayappraiseesname_help'] = 'If activated, the user can see the name of the person he is assessing. Do not activate if appraisee must stay anonymous.';
$string['displayappraisersname'] = 'Display appraisers name';
...
$string['editingassessment'] = 'Editing assessment';
...
$string['fullname'] = '<a href="{$a->url}">{$a->name}</a>';
$string['fullnamewithoutlink'] = '{$a}';
$string['givengrades'] = 'Grades given';
$string['gradecalculated'] = 'Calculated grade for submission';
$string['gradecalculatedfrompeer'] = 'Calculated grade from peer';
...
$string['gradeoverfrompeer'] = 'Override grade from peer';
...
$string['modulename'] = 'UDM Workshop';
...
$string['nullgrade'] = '-';
$string['opensetupwizard'] = 'Open setup wizard';
$string['otherphases'] = 'Other phases';
...
$string['peerallocation'] = 'Peer allocation';
...
$string['phasesubmissionandassessment'] = 'Submission and assessment phase';
$string['pluginadministration'] = 'Workshop administration';
$string['pluginname'] = 'UDM Workshop';
...
$string['publishassessment'] = 'Publish assessment';
$string['publishassessment_help'] = 'Published assessments are available to the others when the workshop is closed.';
...
$string['receivedassessments'] = 'Assessment(s) received';
...
$string['selfandpeerassessment'] = 'Self and peer assessment';
...
$string['submissionassessmentreport'] = 'Workshop submissions and assessments report';
...
$string['submissionrequired'] = 'You can not assess as long you do not submit your work';
...
$string['taskallpeersassessed'] = 'All eligible peers were assessed';
$string['taskallpeersnotassessed'] = 'All eligible peers were not all assessed yet';
$string['taskallpeersnotsubmitted'] = 'All peer associated with you have not yet all submitted their work. So you can not evaluate them all';
...
$string['worknotsubmitted'] = 'You didn\'t have submit your work yet';
$string['worksubmitted'] = 'Your work is currently submitted';
