 ...
 */
class mod_udmworkshop_events_testcase extends advanced_testcase {
    ...
    public function test_assessment_evaluated() {
        ...
        $this->assertInstanceOf('\mod_udmworkshop\event\assessment_evaluated', $event);
    ...
    public function test_assessment_reevaluated() {
        ...
        $this->assertInstanceOf('\mod_udmworkshop\event\assessment_reevaluated', $event);
        $this->assertEquals('workshop_aggregations', $event->objecttable);
        $this->assertEquals(context_module::instance($cm->id), $event->get_context());
    ...
    public function test_aggregate_grades_reset_event() {
        ...
        $event = \mod_udmworkshop\event\assessment_evaluations_reset::create(array(
    ...
    public function test_instances_list_viewed_event() {
        ...
        $event = \mod_udmworkshop\event\course_module_instance_list_viewed::create(array('context' => $context));
    ...
    public function test_submission_created_event() {
        ...
        $event = \mod_udmworkshop\event\submission_created::create(array(
    ...
    public function test_submission_updated_event() {
        ...
        $event = \mod_udmworkshop\event\submission_updated::create(array(
                'objectid'      => $submissionid,
                'context'       => $this->context,
                'courseid'      => $this->course->id,
                'relateduserid' => $user->id,
    ...
    public function test_submission_viewed_event() {
        ...
        $event = \mod_udmworkshop\event\submission_viewed::create(array(
                'objectid'      => $submissionid,
                'context'       => $this->context,
                'courseid'      => $this->course->id,
                'relateduserid' => $user->id,
