...
class workshop_accumulative_assessment_form extends workshop_assessment_form {
    ...
    protected function definition_inner(&$mform) {
        ...
        for ($i = 0; $i < $nodims; $i++) {
            // dimension header
            $dimtitle = get_string('dimensionnumber', 'udmworkshopform_accumulative', $i+1);
            ...
            $label = get_string('dimensiongradefor', 'udmworkshopform_accumulative', $dimtitle);
            ...
            $mform->addRule(array('grade__idx_' . $i, 'minusone') , get_string('mustchoosegrade', 'udmworkshopform_accumulative'), 'compare', 'gt');

            // comment
            $label = get_string('dimensioncommentfor', 'udmworkshopform_accumulative', $dimtitle);
